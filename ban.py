...
# ===== Tool login =====
tool_username = "kathara"
tool_password = "nappier"
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⢿⣿⣿⣿⣿⠟
''')
        typewriter(Fore.YELLOW + "This tool was made by kathara(nappier) alone.\n", delay=0.06)
        break
    else:
...
''')
    ...
    if choice in ["1", "2"]:
        ...
        while True:
            phone = input("📞 Enter WhatsApp number with country code (e.g., +254116141463): ").strip()
...
"""
        ...
        phone = input("📞 Enter the WhatsApp number (e.g., +254116141363): ")
        print("\n⏳ Checking number...")
        time.sleep(1.5)
...
• Description: This number is impersonating, scamming, and deceiving people by pretending to be kathara or fisi vajo , using false claims to defraud victims.  
